...
1. **Generate OTP**
   - Follow the instructions in the [Generate OTP script](https://github.com/kambalatech/NorenApi-java/blob/master/src/main/java/com/kspl/norenexampleapp/NorenExampleApp.java#L37).

2. **Use OTP for Login**
   - Use the generated OTP as `factor2` in the login process.
   - Refer to the [Login script](https://github.com/kambalatech/NorenApi-java/blob/master/src/main/java/com/kspl/norenexampleapp/NorenExampleApp.java#L81) for implementation details.
